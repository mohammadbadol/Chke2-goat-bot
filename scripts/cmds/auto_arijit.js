  ...
  onChat: async function ({ event, message }) {
    try {
      ...
      if (hitById || hitByNameInMention || hitByNameInText) {
        const replies = [
          "👋 এই যে বাবু! Aru বস এখন ব্যস্ত আছেন 😼 যা বলার আমাকেই বলুন~ ❤️",
          "😼 Aru বস এখন মগে চা নিয়ে Titanic pose দিচ্ছে ☕🚢",
          "😂 বস এখন পেটুক মুডে আছে, বিরিয়ানি শেষ না হওয়া পর্যন্ত ডিস্টার্ব কোরো না~ 🍛",
          "🐱 বস এখন মশা মারার মিশনে আছে, পরে কথা বলবে 😹",
          "🐱 বস busy নয়, actually lazy আছে 😼 তবু আমাকেই বলো~"
        ];
